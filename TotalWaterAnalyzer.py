...
class WaterAnalyzer:
    ...
    def analyze(self, path):
        ...
        calculated_object = CalculatedObject(ca, CB, N, hoh)
        self.intermediate_calculations(calculated_object)
    ...
    def write_orientational_data(self, hoh):
        ...
        if H1.x == 0 or H2.x == 0 or OH2.x == 0:
            return
...
path = "C:\\Users\\softc\\Science\\poly_amino_acids\\polyarg\\frames\\frames.pdb"
w = WaterAnalyzer()
